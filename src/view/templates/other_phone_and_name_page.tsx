...
import { BloodTypeAndMotivationPage } from "./blood_type_and_motivation_page";
  ...
  export const OtherPhoneAndNamePage = () => {
    ...
    const onPressed = () => {
      const otherPhoneAndNameSubmitDoc = doc(db, "otherPhoneAndNameSubmission", "wSTeNxF4tp4LK6QOnC7k");
    ...
    const fetchotherPhoneAndNameSubmissionCount = async () => {
      ...
      const phoneAndNameSubmiiRef = doc(db, "otherPhoneAndNameSubmission", "wSTeNxF4tp4LK6QOnC7k");
    ...
    return (
      <div className={classes.root}>
        ...
        <Routes>
          <Route path="/sixth_page" element={<BloodTypeAndMotivationPage />}></Route>
        </Routes>
      </div>
    );
  };
