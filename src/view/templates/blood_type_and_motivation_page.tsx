...
import { SchoolInfoPage } from "./school_info_page";
  ...
  export const BloodTypeAndMotivationPage = () => {
    ...
    const onPressed = () => {
      const bloodTypeAndMotivationSubmitDoc = doc(db, "bloodTypeAndMotivationSubmission", "YkUZ38YRtTgjXKbPshm6");
    ...
    const fetchBloodTypeAndMotivationSubmissionCount = async () => {
      ...
      const bloodTypeAndMotivationSubmitRef = doc(db, "bloodTypeAndMotivationSubmission", "YkUZ38YRtTgjXKbPshm6");
